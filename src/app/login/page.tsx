        ...
        <div className="h-[100dvh] overflow-hidden flex items-center justify-center bg-zinc-950 text-white p-4">
            <div className="w-full max-w-md space-y-8">
                ...
                <div className="mt-8 space-y-6">
                    <button
                        onClick={handleLogin}
                        className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-zinc-800 rounded-xl hover:bg-zinc-900 transition-colors bg-zinc-900/50"
                    >
                        {/* Simple Google Icon SVG or Image */}
